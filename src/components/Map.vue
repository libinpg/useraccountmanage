  ...
  <div class="map">
    ...
    <div class="map-panel">
      <b-collapse class="panel box is-paddingless" :open.sync="panelOpen">
        ...
        <p class="panel-tabs">
          <a @click="showMapPanelTab('state')" :class="mapPanelTabClasses('state')">状态</a>
          <a @click="showMapPanelTab('layers')" :class="mapPanelTabClasses('layers')">图层</a>
          <a @click="showMapPanelTab('draw')" :class="mapPanelTabClasses('draw')">绘制</a>
        </p>
